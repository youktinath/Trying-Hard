 ...
 * watermelon was weighed, and the scales showed w kilos. They rushed home, dying of thirst, 
...
public class Watermelon {
	public static String isEvenlyDivided(int weight) {
		if (weight == 2) return "NO";
		if(weight % 2 == 1) return "NO";
		return "YES";
	}
	public static void main(String[] args) {
		Scanner in = new Scanner(System.in);
		int w = in.nextInt();
		System.out.println(isEvenlyDivided(w));
	}
